...
export function EmployeesCtaSection() {
  return (
    <section className="bg-[#003B36] py-10 lg:py-16">
      <Container>
        <div className="relative min-h-80 overflow-hidden rounded-3xl lg:min-h-96">
          ...
          <div className="relative z-10 flex max-w-xl flex-col justify-center px-6 py-14 sm:px-10 lg:px-14 lg:py-20">
            <h2 className="font-georgia text-3xl leading-tight font-bold text-white sm:text-4xl lg:text-[2.75rem]">
            ...
            <div className="mt-8">
              <Button
                asChild
                size="lg"
                className="rounded-md px-5 text-[16px] font-semibold"
              >
